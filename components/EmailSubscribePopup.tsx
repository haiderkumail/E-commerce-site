...
const EmailSubscribePopup = ({ onClose }: { onClose: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-sm sm:max-w-md relative">
        <button
          onClick={onClose}
        ...
        {!submitted ? (
          <>
            <h2
              className="text-lg sm:text-xl font-normal mb-4 uppercase text-center"
          ...
          <>
            <h2 className="text-lg sm:text-xl font-semibold mb-4 text-green-600 text-center">
              Thank you for subscribing!
            </h2>
            <p className="text-center mb-4">
              We&apos;ll keep you updated with our latest products and offers.
            </p>
            <button
              onClick={onClose}
              className="w-full bg-gradient-to-r from-black to-yellow-500 text-white py-2 rounded hover:from-gray-900 hover:to-yellow-400 transition"
